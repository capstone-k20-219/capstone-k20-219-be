...
let ServiceBookingsService = class ServiceBookingsService extends base_service_1.BaseService {
    constructor(_serviceBookingRepo) {
        super(_serviceBookingRepo, 'service_booking');
        this._serviceBookingRepo = _serviceBookingRepo;
    }
};
...
exports.ServiceBookingsService = ServiceBookingsService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(service_booking_entity_1.ServiceBooking)),
