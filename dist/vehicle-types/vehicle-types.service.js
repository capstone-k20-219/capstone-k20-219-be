...
let VehicleTypesService = class VehicleTypesService extends base_service_1.BaseService {
    constructor(_vehicleTypeRepo) {
        super(_vehicleTypeRepo, 'vehicle_type');
        this._vehicleTypeRepo = _vehicleTypeRepo;
    }
};
